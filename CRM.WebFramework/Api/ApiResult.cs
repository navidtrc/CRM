...
namespace CRM.WebFramework.Api
{
    ...
    public class ApiResult<TData> : ApiResult where TData : class
    {
        ...
        public static implicit operator ApiResult<TData>(BadRequestObjectResult result)
        {
            ...
            return new ApiResult<TData>(true, ApiResultStatusCode.Success, (TData)result.Value, message);
        }
        ...
        {
            return new ApiResult<TData>(true, ApiResultStatusCode.NotFound, null);
        }
