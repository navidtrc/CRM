...
namespace CRM.Application.WebFramework.Api
{
    public class ApiResult
    {
        ...
        {
            return new ApiResult(result.IsSuccess, result.IsSuccess ? ApiResultStatusCode.Success : ApiResultStatusCode.BadRequest, result.Message);
        }
        ...
        where TData : class
    {
        ...
        {
            return new ApiResult<TData>(result.IsSuccess, result.IsSuccess ? ApiResultStatusCode.Success : ApiResultStatusCode.BadRequest, result.Data);
        }
