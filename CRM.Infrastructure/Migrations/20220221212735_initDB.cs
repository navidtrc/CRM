        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeTitle = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoice_Lookup_StateId",
                        column: x => x.StateId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Device_Lookup_DeviceBrandId",
                        column: x => x.DeviceBrandId,
                        principalSchema: "dbo",
                        principalTable: "Lookup",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Device_Lookup_DeviceTypeId",
